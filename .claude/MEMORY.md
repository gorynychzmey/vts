...
- Version: `vts/__init__.py` · bump is done automatically by `prepare_commit.sh` (do NOT call bump_version.py separately)

## Git Workflow (ALWAYS FOLLOW → see [git_workflow.md](git_workflow.md))

Every completed task: **prepare_commit.sh → git add → commit → push**
